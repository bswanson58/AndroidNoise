...
public class ThreadExecutor {
	...
	private static final ThreadPoolExecutor sExecutor = new ThreadPoolExecutor(
			CORE_POOL_SIZE, MAXIMUM_POOL_SIZE, KEEP_ALIVE, TimeUnit.SECONDS, sWorkQueue, sThreadFactory );

	public static void runTask( Runnable task ) {
		Log.d( TAG, String.format( "Running ThreadExecutor Task = %d", sWorkQueue.size()));
