...
// from: http://stackoverflow.com/questions/16017165/auto-fit-textview-for-android
// source: http://pastebin.com/e6WyrwSN

/**
 * This class builds a new android Widget named AutoFitTextView which can be used instead of a TextView
...
public class AutoFitTextView extends TextView {
	...
	/**
	 * Main method of this widget. Resize the font so the specified text fits in the text box
	...
	public void setText( CharSequence text, BufferType type ) {
		...
		if( targetFieldWidth <= 0 || targetFieldHeight <= 0 || text.equals( "" ) ) {
			// Log.v("tag", "Some values are empty, AutoFitTextView was not able to construct properly");
		}
		else {
	...
	public void setMaxLines( int maxLines ) {
		...
		if( maxLines == 1 ) {
			...
			throw new UnsupportedOperationException( "MaxLines != 1 are not implemented in AutoFitTextView yet, use TextView instead" );
		}
	}
